...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact & Rendez-vous — Cabinet Dr. Ben Salah" },
      {
        name: "description",
        content:
          "Prenez rendez-vous au cabinet Dr. Amira Ben Salah à Tunis. Adresse, téléphone, horaires.",
      },
      { property: "og:title", content: "Contact & Rendez-vous" },
      {
        property: "og:description",
        content: "Réservez votre consultation à Tunis.",
      },
    ],
  }),
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      ...
      toast.success("Demande envoyée !", {
        description:
          "Nous vous recontacterons sous 24h pour confirmer votre RDV.",
      });
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 md:py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            Remplissez le formulaire ou appelez-nous directement. Nous répondons
            sous 24h.
          </p>
        </div>
        ...
        <div className="mt-14 grid gap-10 md:grid-cols-5">
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="reason"
                    name="reason"
                    placeholder="Consultation, urgence..."
                  />
                </div>
              </div>
              <div className="space-y-2">
          ...
          <aside className="space-y-4 md:col-span-2">
            ...
            <InfoCard icon={Phone} title="Téléphone">
              <a href="tel:+21671234567" className="hover:text-primary">
                +216 71 234 567
              </a>
            </InfoCard>
        ...
        <div className="mt-16 overflow-hidden rounded-3xl border border-border">
          <iframe
            ...
            src="https://www.openstreetmap.org/export/embed.html?bbox=10.16%2C36.79%2C10.20%2C36.81&layer=mapnik"
